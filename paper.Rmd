...
######## function to calculate 3 quantiles
qq <- function (data, digits) { 
  as.numeric(formatC(quantile(x = data, probs = c(0.025, 0.50, 0.975), na.rm = TRUE),
...
d_all <- as_tsibble(readRDS(file = paste0(path_data, "fb_data/d_all.rds")), index = datetime) 
d <- d_all %>% 
  #dplyr::select
