...
# period 2, mean of 4 next hours for volt int + T seaF
mean_voltINT_4h <- d_all%>%
...
# period 20, mean of 4 previous hours for volt int + T seaF
mean_voltINT_4h <- d_all%>%
...
# period 21, mean of 4 previous hours for volt int + T seaF
mean_voltINT_4h <- d_all%>%
...
# # #@@@@@ test plot #@@@@@ #@@@@@ #@@@@@ 
# seafet_contros_xts <- dplyr::select(d_all, datetime, voltINT, phINT_filtered,pH_s_seafet_temp_field, T_seaF, temp_fb, temp_insitu, sal_fb,pHint_tot_sf)
# #seafet_contros_xts <- dplyr::select(d_all, datetime,voltINT)
# seafet_contros_xts <- as.xts(seafet_contros_xts, order.by = d_all$datetime)
# dygraph(seafet_contros_xts, group = "awipev", main="pH seaFET (in situ)", ylab="pHT") %>%
