...
### All K1K2 using pCO2-AT

```{r impact of constants on spec pH using FerryBox pCO2 and at, echo=FALSE, warning=FALSE, message=FALSE}
tmp <- d_all %>% 
...
### All K1K2 using CT and AT

```{r impact of constants on spec pH using FerryBox ct and at, echo=FALSE, warning=FALSE, message=FALSE}
tmp <- d_all %>% 
