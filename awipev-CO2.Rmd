...
p <- ggplot(diff_all_long, aes(x=factor(deltas), y=value))+
  geom_boxplot(notch=FALSE, size=0.2, fill="grey50", outlier.color = "blue", outlier.size = 0.3) +
  labs(title = "", x = "Depth (m)", y= "delta") +
...
`r knitr::kable(diff_ls_quant, digits = c(0, rep(3, 5)), caption = "Lueker minus Papadimitriou using all pCO2 data.", format = "simple")`
`r knitr::kable(diff_ls_quant, digits = c(0, rep(3, 5)), caption = "Lueker minus Millero using all pCO2 data.", format = "simple")`
