...
p_f_air_sea <- ggplot(data=d_all) +
  ...
  labs(title = "Air-sea CO2 flux", x = "Time", y = "CO2 (mmol/(m2 h))") +
  Mytheme(size_labs = 8)
p_f_air_sea
...
p_f_air_sea_d <- ggplot(data = air_sea_day) +
  ...
  labs(title = "Air-sea CO2 flux", x = "Time", y = "CO2 (mmol/(m2 d))") +
  Mytheme(size_labs = 8)
p_f_air_sea_d
...
p_f_air_sea_m <- ggplot(data = air_sea_month) +
  geom_point(aes(x = month, y = f_air_sea), col = "blue", size = 0.15, na.rm = TRUE) +
  scale_x_discrete(breaks=c("Jan", "", "Mar", "", "May", "", "Jul", "", "Sep", "", "Nov", "")) +
  labs(title = "Air-sea CO2 flux", x = "Time", y = "CO2 (mmol/(m2 month))") +
  Mytheme(size_labs = 8)
p_f_air_sea_m
