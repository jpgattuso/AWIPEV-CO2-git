...
#   geom_point(data=d_all, aes(x=datetime, y=pco2calc), col="red" )+
#   geom_point() +geom_point(data=noaa%>%dplyr::filter(analysis_value > 150), aes(x=datetime, y= analysis_value),size=0.5 ) +
#   scale_color_manual("",values=c("red", "blue", "black"), labels=c("pH spectro", "seaFET EXT ", "seaFET EXT corrected"))+
#   labs(x = "", y ="", title = expression(paste(italic(p),CO[2]," (µatm)"))) +
