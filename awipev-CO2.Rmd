...
```{r Range per month, eval = FALSE, echo=FALSE, message= FALSE, warning=FALSE}
...
# ph_s_sf_t_insi = spectrophotometric pH in situ at in situ temperature 
# ph_s_dur_t_fb = spectrophotometric pH in FerryBox at FerryBox temperature
# pco2 = pCO2 in Ferrybox expressed at in situ temperature
