...
Mytheme <- function(size_labs = 6, face_font="plain", ...) {
  ...
  theme(
    ...
    #     axis.title.x = element_text(face="plain", size=size_labs, margin=margin(0,0,0,0,"pt")),
    #     axis.text.y = element_text(face=face_font, color="black", size=size_labs),
    axis.text.x = element_blank(),
    #     axis.title.y = element_text(face="plain", size=size_labs),
    #     axis.ticks.x = element_line(size=0.1),
    #     axis.ticks.y = element_line(size=0.1),
    #     axis.ticks.length = unit(1.1, "mm"),
    #     panel.grid.major = element_line(size = 0.2, color="black", linetype="dotted"),
    #     aspect.ratio = 1 / 3,
...
cp <- cowplot::plot_grid(ts_sal, ts_temp, ts_pco2, ts_ph, ts_at, 
                   align = "v",
                   #labels = "AUTO",
                   ncol = 1
                   #width = 18,
