...
#fit <- lmodel2(formula = y  ~ x, data = data, nperm = 99)
  print(y)
  #return(fit)
...
lm2(x = d_all$pco2_calc_fb, y = d_all$pco2_fb)
lm2(data = d_all, x=pco2_calc_fb, y=pco2_fb)

lmodel2(d_all$pco2_calc_fb ~ d_all$pco2_fb, nperm = 99)
  ...
  predicted <- intercept_OLS + df[[x]] * slope_OLS
  error <- x - predicted
