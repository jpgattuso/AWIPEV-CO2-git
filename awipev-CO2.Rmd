...
### Lueker vs Sulpis using FerryBox pCO2 and at in situ
```{r impact of constants on FerryBox data, echo=FALSE, warning=FALSE, message=FALSE}
# Compare Lueker and Sulpis using pco2_fb and at in situ
tmp <- d_all %>% 
...
The discrete values of pCO2, salinity and temperature in the FerryBox and in situ AT were used to calculate pH from measured pCO2 and AT using the formulations for K1 and K2 of Lueker et al. (2000) and Sulpis et al. (2020). The differences induced by the choice of the carbonic acid constants is:
