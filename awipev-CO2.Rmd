...
-   large for pH (`r round(diff_ls_quant[4, 2], digits = 3)` pH units on
    ...
    higher with Sulpis than with Lueker.
-   reasonable for pCO2 (`r round(diff_ls_quant[4, 3], digits = 1)` umol/kg on
    average; always larger with Sulpis than with Lueker) compared with
    the uncertainty calculated with seacarb
    (`r round(errors[1, 8], digits = 1)`)
-   negligible for OmegaAragonite

`r knitr::kable(diff_ls_quant, digits = c(0, 4, 1, 3), caption = "Lueker minus Sulpis using all discrete Ferrybox data.", format = "simple")`
