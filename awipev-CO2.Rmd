...
png("poster_sal_temp.png", width= 1100, height=600)
...
mtext("Time",side=1,col="black",line=1.5, cex=1.8)
...
#                      plot.title = element_text(hjust =0.1, vjust = 1,size = rel(1.5),margin = margin(t = 10, b = -20)),
#                      axis.text=element_text(size=15),
#                      axis.title.x= element_text(size =15),
...
poster_pco2 <- ggplot( ) +
  ...
  labs(x = "Time", y ="", title = expression(~italic(p)~CO[2]~"(µatm)")) +
  theme_bw() + theme(legend.position= c(0.59, 0.1),
...
#   labs(x = "Time", y ="", title = expression(pH[T]~seaFET)) +
...
#   labs(x = "Time", y= "", title = expression(pH[T]~durafet)) +
