...
---
![ ](../fb_server/shinyroot/AWIPEV-CO2/www/AWIPEV-Logo.jpg){width=250px}
...
d <- read.table("../fb_data/Discrete_analyses_AT_CT/Discrete_sampling_AWIPEV.csv", header = T, dec = ".", as.is = T, sep = ";", fill = TRUE) 
...
load(file = "../fb_server/shinyroot/AWIPEV-CO2/nydata_hour_shiny.Rdata")
...
save(file="../fb_data/d_all.Rdata", d_all)
...
<div style="text-align:center" markdown="1">
  <img  src="../fb_figures/Photos/Outside/Container.png" width="200" height="200">
  <img  src="../fb_figures/Photos/Outside/Intake.png" width="200" height="200">
  <img  src="../fb_figures/Photos/FerryBox/2018-04-17_Ferrybox2.jpg" width="200" height="200">
...
TAevents <- c("2016-02-26 00:00:00", "2017-02-09 12:00:00", "2017-02-09 12:00:00", "2017-03-10 12:00:00", "2018-01-07 00:00:00", "2018-07-31 00:00:00", format(Sys.Date(), "%Y-%m-%d %H:%M:%S"))
...
dygraph(at_contros_cleaned_xts, group = "awipev", main=" Total Alkalinity (in Ferrybox)", ylab="Total alkalinity") %>%
  ...
  dyShading(from = TAevents[6], to = TAevents[7], color = "#C2C2C2") %>%
...
calib_analyser <-  read.table("../fb_data/Calibration/TA_#1215/measure_CRM_TA.txt", header = T, dec = ".", as.is = T, sep = ",", fill = TRUE) 
...
ggsave("../fb_figures/TA_Analyser/Calibration/TA_calibration_CRM.png", calib_p, units="cm")
print(calib_p)
```
...
print(p)
ggsave("../fb_figures/TA_Analyser/Calibration/Diff_ref_TA_first_period.png", p, units="cm")
```
...
print(p)
ggsave("../fb_figures/TA_Analyser/Calibration/Diff_ref_TA_third_period.png", p, units="cm")
```
...
ggsave("../fb_figures/Discrete_TA_salinity_AWIPEV.png", at_s, width=15, height =10, units="cm")
...
ggsave("../fb_figures/pco2calc_pCO2_contros.png", pco2calc_pCO2_contros_text, width=5, height=5, units="cm")
```
...
ggsave("../fb_figures/SNAPO/delta_at_awipev_snapo.png", pdelta_at_snapo, units="cm")
ggsave("../fb_figures/SNAPO/delta_ct_awipev_snapo.png", pdelta_ct_snapo, units="cm")
```

##Maintenance
<div style="text-align: justify"> 
- **2018-10-15**: FB is stopped after a seawater leakage. 
...
- **2018-04-14**: Ferrybox is working again. They made an outlet "by-pass" tube to flush the seawater directly on the beach, not at 11 m.  
...
- **2017-08-24**: One durafet was installed in the Ferrybox and seaFET #1005 on the REMOS into the field.
...
- **2017-01-31**: Beginning of the 14-days maintenance by Philipp and Uwe. Gaps in data could be present during this period.
...
<div style="text-align:center" markdown="1">
<img  src="../fb_figures/Photos/Salt/2016-04-04_leakage_AT_analyser1.jpg" width="200" height="200">
<img  src="../fb_figures/Photos/Salt/2016-04-04_leakage_AT_analyser3.jpg" width="200" height="200">
</div>
