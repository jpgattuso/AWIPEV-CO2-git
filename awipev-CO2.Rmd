...
We first calculate fCO2 from pCO2 and then express fCO2 at in situ temperature. Ideally, this should be done with SST as the goal is to estimate air-sea CO2 fluxes. I therefroe use the in situ temperature at 11 m and we will need to speculate on stratitication.
