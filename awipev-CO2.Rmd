...
d_all <- d_all %>%
  dplyr::mutate(deployment_sf = ifelse(datetime >= sfinterv[1] & datetime <= sfinterv[2], 01, 
                                ...
                                ifelse(datetime >= sfinterv[20] & datetime <= sfinterv[22], 21,
                                ifelse(datetime >= sfinterv[20] & datetime <= sfinterv[23], 22,
                                ifelse(datetime >= sfinterv[20] & datetime <= sfinterv[24], 23,
                                ifelse(datetime >= sfinterv[20] & datetime <= sfinterv[25], 24,
                                ifelse(datetime >= sfinterv[20] & datetime <= sfinterv[26], 25,
...
#@@@@@ test plot #@@@@@ #@@@@@ #@@@@@ 
# seafet_contros_xts <- dplyr::select(d_all, datetime, voltINT, phINT_filtered,pH_s_seafet_temp_field, T_seaF, temp_fb, temp_insitu)
# #seafet_contros_xts <- dplyr::select(d_all, datetime,voltINT)
# seafet_contros_xts <- as.xts(seafet_contros_xts, order.by = d_all$datetime)
# dygraph(seafet_contros_xts, group = "awipev", main="pH seaFET (in situ)", ylab="pHT") %>%
