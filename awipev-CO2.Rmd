...
ts_temp <- d_all %>%
  ...
  scale_x_datetime(breaks = date_breaks("1 year"), labels = date_format("%Y")) +
  geom_point(colour="blue", alpha = alpha, na.rm = TRUE, size = size_point) +
  labs(title="B",x="", y="Temperature (°C)") +
  Mytheme(size_labs = size_labs) +
  theme(axis.title.x = element_text(face = "bold", size = size_labs),
        axis.title.y = element_text(face = "bold", size = size_labs),
        title = element_text(colour="black", size=14, face="bold")
...
ts_sal_bp <- d_bp %>%
  ...
  labs(title="F", y = "Salinity", x=NULL) +
  Mytheme(size_labs = size_labs) +
  theme(panel.grid.major.x = element_blank(),
#        aspect.ratio=0.5,
        axis.title.x = element_text(face = "bold", size = size_labs),
...
ts_temp_bp <- d_bp %>%
  ...
  labs(title="G", y = "Temperature (°C)", x=NULL) +
  Mytheme(size_labs = size_labs) +
  theme(panel.grid.major.x = element_blank(),
#        aspect.ratio=0.5,
        axis.title.x = element_text(face = "bold", size = size_labs),
...
ts_pco2_bp <- d_bp %>%
  ...
  labs(title="H", y = latex2exp::TeX("pCO$_2$ ($\\mu atm$)", bold = TRUE), x=NULL) +
  Mytheme(size_labs = size_labs)+
  theme(panel.grid.major.x = element_blank(),
#        aspect.ratio=0.5,
        axis.title.x = element_text(face = "bold", size = size_labs),
...
ts_pH_bp <- d_bp %>%
  ...
  labs(title="I", y = latex2exp::TeX("$pH_T$", bold = TRUE), x=NULL) +
  Mytheme(size_labs = size_labs) +
  theme(panel.grid.major.x = element_blank(),
#        aspect.ratio=0.5,
        axis.title.x = element_text(face = "bold", size = size_labs),
...
ts_at_bp <- d_bp %>%
  ...
  labs(title="J", y = TeX("$A_T$ ($\\mu mol\\phantom{x}kg^{-1})$", bold = TRUE), x=NULL) +
  Mytheme(size_labs = size_labs) +
  theme(panel.grid.major.x = element_blank(),
#        aspect.ratio=0.5,
        axis.title.x = element_text(face = "bold", size = size_labs),
...
ggsave(filename = "figures/essd/ts.pdf", plot = g, width = 12)
# legend:
# - Salinity below 8m
# - In situ temperature (11m)
# - pCO2 at 11 m and insitu Temperature, measued in blue, calculated from CT an AT in red
