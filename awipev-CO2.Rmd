...
### Lueker vs Sulpis using FerryBox pCO2 and at_calc
...
tmp <- d_all %>% 
  ...
  dplyr::select(ph_s_dur_temp_4, pco2_fb, at_calc, sal_fb, temp_fb)
# Using Lueker  
...
tmp2 <- tibble(ph_s_dur_temp_4 = tmp$ph_s_dur_temp_4, pH_l = carb_l$pH, pH_s = carb_s$pH, pH_p = carb_p$pH, pH_m = carb_m$pH) %>% 
