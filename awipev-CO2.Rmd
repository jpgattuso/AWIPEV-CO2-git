...
pangaea <- as_tibble(d_all) %>% 
  dplyr::select(datetime, depth, sal_insitu_ctd, sal_fb, temp_insitu_11m, temp_insitu_ctd, temp_fb, temp_sf, at, ct, ph_s_sf_temp_insi, ph_s_dur_temp_fb, ph_calc_fb, pco2_fb, pco2_calc_fb, at_calc, pH_dur, pHint_tot_sf) %>%
  dplyr::rename(pressure = depth,
                s_insitu = sal_insitu_ctd,
                s_fb = sal_fb, 
                t_11m = temp_insitu_11m,
                t_ctd = temp_insitu_ctd, 
                t_fb = temp_fb, 
                t_s = temp_fb,
                t_sf = temp_sf, 
                at = at, 
                ...
                pco2 = pco2_fb_insi_temp,
                pco2_calc = pco2_calc_fb_insi_temp,
                pH_sf = pHint_tot_sf,
                pH_dur = pH_dur,
                ph_calc = ph_calc_fb
                )
