...
diff_all_long <- diff_all %>% 
  tidyr::pivot_longer(-deltas, names_to = "variable") %>% 
  dplyr::mutate(variable = forcats::fct_relevel(variable, 'delta_ph', 'delta_pCO2', 'delta_OmegaAragonite'), variable = fct_recode(variable, 'pH' = "delta_ph", 'pCO[2]' = "delta_pCO2",'Omega[a]' = "delta_OmegaAragonite"))
...
were used to calculate pH and pCO2 using the formulations for K1 and K2 of Lueker
