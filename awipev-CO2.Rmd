...
# We take temp_mix/sal_mix because of the depth (temp11m insitu + temp9m ctd)
...
range_month <-
  d_all %>%
  dplyr::select(montht, sal_mix, temp_mix, temp_insitu_11m, pHint_tot_sf_9m) %>% 
  group_by(montht) %>%
  my_skim()
