...
ggsave(filename = "figures/essd/availability.pdf", plot = p, width = 20, height = 15, units = "cm")
...
p <- ggplot(diff_all_long, aes(x = forcats::fct_relevel(deltas, 'L00-S20', 'L00-P18', 'L00-M02'), y=value))+
  geom_boxplot(notch=FALSE, size=0.2, fill="grey70", outlier.color = "blue", outlier.size = 2) +
...
ggsave(filename = "figures/essd/k1k2_pco2_at.pdf", plot = p, width = 25, height = 20, units = "cm")
...
ggsave(filename = "figures/essd/k1k2_ct_at.pdf", plot = p, width = 25, height = 20, units = "cm")
# prepare tibble to compare calculated pH and spec pH
tmp2 <- tibble(datetime = tmp$datetime, ph_s_dur_temp_4_l = tmp$ph_s_dur_temp_4_l, 
               ph_s_dur_temp_4_s20 = tmp$ph_s_dur_temp_4_s20,
               ph_s_dur_temp_4_p18 = tmp$ph_s_dur_temp_4_p18,
...
ggsave(filename = "figures/essd/taka_month.pdf", plot = taka_month_plt, width = 25, height = 25, units = "cm")
...
ts_pCO2 <- d_all %>%
  ...
  labs(title=NULL,
       subtitle = NULL,
       x="", y=latex2exp::TeX("pCO$_2$ ($\\mu atm$)", bold=TRUE)) +
  Mytheme(size_labs = size_labs) +
  theme(axis.title.x = element_text(face = "bold", size = size_labs),
        axis.title.y = element_text(face = "bold", size = size_labs))
...
ts_pH <- d_all %>% 
  ...
  labs(title=NULL, 
       subtitle =NULL,
       x = "", y=latex2exp::TeX("pH$_T$", bold=TRUE)) +
  Mytheme(size_labs = size_labs) +
...
ts_at <- d_all %>%
  ...
  labs(title=NULL, 
       subtitle = NULL,
       x="", y=latex2exp::TeX("$A_T$ ($\\mu mol\\phantom{x}kg^{-1})$", bold = TRUE)) +
  Mytheme(size_labs = size_labs) +
  theme(axis.title.x = element_text(face = "bold", size = size_labs),
        axis.title.y = element_text(face = "bold", size = size_labs))
...
ts_pco2_bp <- d_bp %>%
  ...
  labs(title=NULL, y = latex2exp::TeX("pCO$_2$ ($\\mu atm$)", bold = TRUE), x=NULL) +
  Mytheme(size_labs = size_labs)+
  theme(panel.grid.major.x = element_blank(),
        aspect.ratio=0.5,
        axis.title.x = element_text(face = "bold", size = size_labs),
...
ts_pH_bp <- d_bp %>%
  ...
  labs(title=NULL, y = latex2exp::TeX("$pH_T$", bold = TRUE), x=NULL) +
  Mytheme(size_labs = size_labs) +
  theme(panel.grid.major.x = element_blank(),
        aspect.ratio=0.5,
        axis.title.x = element_text(face = "bold", size = size_labs),
...
ts_at_bp <- d_bp %>%
  ...
  labs(title=NULL, y = TeX("$A_T$ ($\\mu mol\\phantom{x}kg^{-1})$", bold = TRUE), x=NULL) +
  Mytheme(size_labs = size_labs) +
  theme(panel.grid.major.x = element_blank(),
        aspect.ratio=0.5,
        axis.title.x = element_text(face = "bold", size = size_labs),
...
ggsave(filename = "figures/essd/pco2_ph_etc.pdf", plot = g)
```
...
ggsave(filename = "figures/essd/ts.pdf", plot = g, width = 20, height = 30)
# legend:
# - Salinity below 8m
# - In situ temperature (11m)
# - pCO2 at 11 m and insitu Temperature, measued in blue, calculated from CT an AT in red
