...
# are used for 2018
atm_co2 <- dplyr::left_join(atm_co2_new, atm_co2_old, by = "datetime") %>% dplyr::rename(co2_air = co2_air.x, co2_air_old = co2_air.y) %>% dplyr::mutate(co2_air = ifelse(year(atm_co2$datetime) == 2018, co2_air_old, co2_air))
summary(atm_co2)
