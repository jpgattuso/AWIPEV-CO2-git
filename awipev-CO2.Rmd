...
d_all <- d_all%>%
  dplyr::mutate( pH_s_sf_no_calb = ifelse(datetime == "2018-04-16 07:00:00" | datetime == "2018-12-14 09:00:00" | datetime == "2019-01-18 09:00:00", ph_s_sf_temp_mix, NA ))

seafet_contros_xts <- dplyr::select(d_all, datetime, phINT, ph_s_sf_temp_mix, pHint_tot_sf, pH_s_sf_no_calb, pressure_insitu_ctd, sal_insitu_ctd, temp_insitu_ctd)
...
seafet_depth_xts <- dplyr::select(d_all, datetime, phINT, ph_s_sf_temp_mix,pHint_tot_sf)
...
dygraph(seafet_depth_xts, group = "depth", main="pH seaFET (ref + corrected + raw)", ylab="pHT") %>%
  dySeries("ph_s_sf_temp_mix", axis="y2", label = "pH spectro for calibration", color =  "red", strokeWidth = 0, pointSize = 4 ) %>%
