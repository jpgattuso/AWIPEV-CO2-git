...
pangaea <- as_tibble(d_all) %>% 
  dplyr::select(datetime, pressure_insitu_ctd, sal_insitu_ctd, sal_fb, temp_insitu_11m, temp_insitu_ctd, temp_fb, temp_sf, temp_dur, at, ct, ph_s_sf_temp_insi, ph_s_dur_temp_fb, pco2_corr, at_calc, ph_dur_corr, pHint_tot_sf) %>%
  dplyr::rename(pressure = pressure_insitu_ctd,
                ...
                at_calc =at_calc,
                ct = ct, 
                ph_s_sf_temp_insi = ph_s_sf_temp_insi, 
                ph_s_dur_temp_fb = ph_s_dur_temp_fb,
                pco2 = pco2_corr,
                pH_sf = pHint_tot_sf,
                ph_dur = ph_dur_corr
                )
...
# ph_s_sf_temp_insi = pH spectrophotometric SeaFET in situ (11 m)
# ph_s_dur_temp_fb = pH spectrophotometric Durafet in FerryBox
