...
p <-  ggplot(d_all,aes(x=pco2_calc_fb, y= pco2_corr, label = monthd))+
   geom_text(aes(color = factor(monthd)))+
  scale_color_discrete(guide="none")+
  geom_abline(slope = 1, intercept = 0, linetype = "dashed") +
...
```
**Conclusion**:
The range is significantly larger during some months when the data deeper than 9 m are considered. Also, pH is sometimes higher at the surface, at other tilmes it is higher on the bottom (June). 
  + To compare with pCO2/pCO2 measured in the Ferryboxt seems therefore better to stick with pH_9m, that is at depths deeper than 8 m.
  + For air-sea CO2 fluxes
