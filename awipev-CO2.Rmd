...
pH_seafet_mean <- pH_seafet%>%
  ...
  dplyr::summarize(ph_s_sf_temp_mix = mean(ph_s_sf_temp_mix, na.rm = TRUE)  )
  #                 ph_s_sf_temp_mix_sd = round(sd(pH_seafet$ph_s_sf_temp_mix, na.rm = TRUE), digits = 4))
...
pH_durafet_mean <- pH_durafet%>%
  ...
  dplyr::summarize(ph_s_dur_temp_fb = mean(ph_s_dur_temp_fb, na.rm = T) )
   #                ph_s_dur_temp_fb_sd = sd(ph_s_dur_temp_fb, na.rm = T)
