...
pH_seafet <- pH_seafet %>%
  dplyr::mutate(ph_s_sf_temp_mix = pHinsi(pH = pH_s_seafet, ALK = at_mean_interp*1e-6, Tinsi = temp_insitu_ctd, Tlab = temp_s_lab, Pinsi = depth/10, S = sal_mix, Pt = 0, Sit = 0))
...
#  dplyr::mutate(ph_s_dur_temp_fb = pHinsi(pH=pH_durafet$pH_s_durafet, ALK=pH_durafet$at_mean_interp*1e-6, Tinsi=pH_durafet$temp_fb, Tlab=pH_durafet$temp_s_lab, Pinsi= pH_durafet$depth/10, S=pH_durafet$sal_fb, Pt=0, Sit=0))
  dplyr::mutate(ph_s_dur_temp_fb = pHinsi(pH = pH_s_durafet, ALK = at_mean_interp*1e-6, Tinsi = temp_fb, Tlab = temp_s_lab, Pinsi = 0, S = sal_fb, Pt = 0, Sit = 0))
