...
# We add a variable depth_group in d_all in order to be able to choose depth_group_pressure or depth_group_p
=======
tmp <- d_hour %>% 
  dplyr::select(date, depth, pressure_insitu_ctd) %>% 
  dplyr::mutate(month=month(d_hour$date, label = TRUE)) %>% 
  group_by(month)


>>>>>>> 71d7bd9efe3e64b3cb3e7fa0231c13e0175b4aec
