...
fit <- lmodel2(data = d_all,  pHint_tot_sf_temp_4 ~ pH_dur_temp_4, nperm = 99)
pdur_sf_norm_text <-  ggplot(d_all,aes(x=pH_dur_temp_4, y= pHint_tot_sf_temp_4, label = monthd))+
...
sal_delta_plt <- tidyr::drop_na(tmp_delta) %>% 
...
temp_delta_plt <- tidyr::drop_na(tmp_delta) %>% 
