...
d_all <- d_all %>%
  dplyr::mutate(delta_pco2 = co2_air - pco2, # ppm
                k600 = 0.266 * ws^2, #cm/hr Ho et al. (2006)
                Sc = 2073.1 - (125.62*temp_insitu_ctd) + (3.6276*temp_insitu_ctd^2) - (0.043219*temp_insitu_ctd^3), #dimensionless
                k = k600 * (Sc/600)^-0.5,
                alp = seacarb::K0(S=sal_mix,T=temp_insitu_ctd,P=0,Patm=p_air/1013.25), #mol/(kg/atm)
                f_air-sea = k * alp * delta_pco2)
```
