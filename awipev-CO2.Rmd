...
d_all <- d_all %>%
  ...
  dplyr::mutate( # create new variable depth
    depth = ifelse(
...
```
The range is significantly larger during some months when the data deeper than 9 m are considered. It seems therefore better to stick pH_çm, that is pH deeper than 8 m.
