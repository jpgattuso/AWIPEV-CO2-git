...
# ) %>% 
  dplyr::mutate(datetime = dmy_hm(sampling_date, tz="UTC"),
                measure_date = ymd(measure_date, tz="UTC"),
...
Spectrophotometric pH which could be used for calibration: 2017-08-24, 2017-09-28, 2019-09-13 x 2.
Spectrophotometric pH which could not be used for calibration : 2018-12-14, 2019-01-18.
...
##########  Despike() ###########
d_all <- d_all %>%   
  dplyr::mutate(pHint_tot_sf = oce::despike(seafet_calib$pHint_tot_sf, reference= "median", n=1, k=5000, replace="NA"),
                pHext_tot_sf = oce::despike(seafet_calib$pHext_tot_sf, reference= "median", n=1, k=5000, replace="NA")
  )
